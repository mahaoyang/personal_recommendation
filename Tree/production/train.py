...
def train_tree_model_core(train_mat, tree_depth, tree_num, learning_rate):
    ...
    Return:Booster
    """
    para_dict = {"max_depth": tree_depth, "eta": learning_rate, "objective": "reg:linear",
                 "silent": 1}
...
def train_tree_and_lr_model(train_file, feature_num_file, mix_tree_model_file, mix_lr_model_file):
    ...
    lr_clf = LRCV(Cs=[1.0], penalty='l2', dual=False, tol=0.0001, max_iter=500, scoring='roc_auc',
                  cv=5).fit(
...
if __name__ == "__main__":
    ...
    #     print(
    #         "train lr_gbdt model usage: python xx.py train_file feature_num_file tree_mix_model lr_coef_mix_model")
    #     sys.exit()
    """
    train_tree_model("../data/train_file", "../data/feature_num", "../data/xgb.model")
